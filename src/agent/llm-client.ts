...
export class LLMClient {
  ...
  private async sendAnthropic(
    ...
    const system = this.systemPrompt
      ? [{ type: "text" as const, text: this.systemPrompt, cache_control: { type: "ephemeral" as const } }]
      : undefined;

    // Add cache_control to the last tool so the entire tool schema block is cached
